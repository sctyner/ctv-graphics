# taken directly from https://github.com/benmarwick/ctv-archaeology/blob/master/ctv2md.r
#!/usr/bin/r
...
check_ctv_packages(system.file("ctv", ctvfile, package = "ctv"))            # run the check

## create html file from ctv file
ctv2html(read.ctv(system.file("ctv", ctvfile, package = "ctv")), htmlfile)
